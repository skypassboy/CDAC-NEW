...
import './App.css';
import one from './first_comp';
import ClassComp from './ClassComp';
import HeaderComponent from './HeaderComp';
import TimeComp from './TimeComp'
import Two from './FunctionalExpression'
import Avatars from "./components/movies";
...
const moviesarr = movies.map((el) => {
  return <Avatars src={el.Poster} name={el.Title} />;
});
function App() {
  return (
    // <div className="App">
    ...
    // 3rd one*********************************************************************************************************
    // <div id={"root"}>
    //   <img src={shiva} className="App-Logo" id={"image"}/>
    // </div>
    ...
    <div className='App' >
      ...
      <Routes>
        ...
        <Route path="/web programming/React/firstreactapp/src/components/movies.js" element={moviesarr} />
